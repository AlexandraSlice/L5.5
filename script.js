...
read_more_768.addEventListener("click", function () {
  ...
  if (read_more_768.classList.contains("active")) { next_text_read_768.innerHTML = b }
  else 
  { next_text_read_768.innerHTML = a } 
...
read_more_1120.addEventListener("click", function () {
  ...
  if (read_more_1120.classList.contains("active")) { next_text_read_1120.innerHTML = b; }
  else 
  { next_text_read_1120.innerHTML = a;  } 
} )
